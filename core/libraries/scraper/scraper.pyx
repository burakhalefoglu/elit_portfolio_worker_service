...
cdef class ScraperApi:
    async def get_all_bist_company(self):
    ...
    async def get_us_sp_500_companies_codes_and_names(self):
    ...
    async def get_germany_dax_40_companies_codes_and_names(self):
    ...
    async def get_british_ftse_350_companies_codes_names(self):
    ...
    async def get_france_cac_40_companies_codes_and_names(self):
    ...
    async def get_spain_ibex_35_companies_codes_and_names(self):
    ...
    async def get_dow_jones_30_companies_codes_and_names(self):
    ...
    async def get_russell_2000_companies_codes_and_names(self):
        company_data_list = []
        for i in range(1, 41):
    ...
    async def get_euro_stoxx_50_companies_codes_and_names(self):
        df = pd.read_html("https://en.wikipedia.org/wiki/EURO_STOXX_50")[3][["Ticker", "Name"]].rename(
            columns={"Name": "title", "Ticker": "code"})
        return df

    async def get_hang_seng_companies_codes_and_names(self):
    ...
    async def get_nikkei_225_companies_codes_and_names(self):
    ...
    async def get_sse_1740_companies_codes_and_names(self):
        company_data_list = []
        for i in range(1, 36):
    ...
    async def get_ftse_mib_40_companies_codes_and_names(self):
        df = pd.read_html("https://disfold.com/stock-index/ftse-mib/companies/")[0][["Company", "Stock Symbol"]]
        return df

    async def get_s_p_tsx_230_companies_codes_and_names(self):
    ...
    async def get_nasdaq_3000_companies_codes_and_names(self):
        company_data_list = []
        for i in range(1, 61):
    ...
    async def get_universal_investpy_company_list(self):
